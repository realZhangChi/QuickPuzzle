...
using QuickPuzzle.ProjectManagement.Blazor;
...
namespace QuickPuzzle.Blazor
{
    ...
    public class QuickPuzzleBlazorModule : AbpModule
    {
        ...
        private void ConfigureRouter(ServiceConfigurationContext context)
        {
            ...
            {
                options.AppAssembly = typeof(QuickPuzzleBlazorModule).Assembly;
            });
        }
        ...
        private void ConfigureMenu(ServiceConfigurationContext context)
        {
            ...
            {
                options.MenuContributors.Add(new QuickPuzzleMenuContributor(context.Services.GetConfiguration()));
            });
        }
        ...
        private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
        {
            builder.Services.AddOidcAuthentication(options =>
            {
                ...
                options.ProviderOptions.DefaultScopes.Add("PermissionManagement");
        ...
        private void ConfigureAutoMapper(ServiceConfigurationContext context)
        {
            ...
            {
                options.AddMaps<QuickPuzzleBlazorModule>();
            });
        }
    }
}
