...
namespace QuickPuzzle.ProjectManagement.EntityFrameworkCore
{
    public static class ProjectManagementDbContextModelCreatingExtensions
    {
        public static void ConfigureProjectManagement(
            ...
            Action<ProjectManagementModelBuilderConfigurationOptions> optionsAction = null)
        {
            Check.NotNull(builder, nameof(builder));

            var options = new ProjectManagementModelBuilderConfigurationOptions(
                ProjectManagementDbProperties.DbTablePrefix,
                ProjectManagementDbProperties.DbSchema
            );
